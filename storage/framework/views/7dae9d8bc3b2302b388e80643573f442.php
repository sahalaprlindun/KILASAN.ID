            ...
            <div class="login-card p-4 p-md-5">
                ...
                <form method="post" action="<?php echo e(route('login.store')); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="username" value="<?php echo e(old('username')); ?>" required autofocus>
                    </div>
                    <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pengmas\KILASAN\resources\views/auth/login.blade.php ENDPATH**/ ?>