...
<body>
    ...
    <div class="header">
        ...
        <img src="data:image/png;base64,<?php echo e($logoLurahData); ?>"
             style="position:absolute; top:0; left:0; width:150px;">

        
        <img src="data:image/png;base64,<?php echo e($logoData); ?>"
    ...
    <?php if($complaint->attachments->count()): ?>
        <div class="attachments">
            ...
            <div style="font-size: 10px; margin-top: 10px;">
                *Isi file tidak disertakan dalam PDF ini.
            </div>
        </div>
    <?php else: ?>
        <div class="attachments">
...
</html><?php /**PATH C:\laragon\www\KILASAN.ID\resources\views/admin/complaints/pdf.blade.php ENDPATH**/ ?>