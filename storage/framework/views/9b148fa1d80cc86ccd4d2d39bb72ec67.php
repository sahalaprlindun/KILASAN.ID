...
<div class="panel">
    ...
    <a class="btn btn-sm btn-outline-primary me-2 mb-2" href="<?php echo e(route('admin.complaints.attachments.show', $attachment, false)); ?>" target="_blank"><?php echo e($attachment->original_name); ?></a>
