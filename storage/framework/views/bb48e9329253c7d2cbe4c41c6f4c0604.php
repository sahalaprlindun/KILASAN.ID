...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin KILASAN'); ?></title>
...
<div class="admin-shell">
    <aside class="sidebar">
        <div class="mb-4">
            ...
            <small class="text-white-50"><?php echo e(auth()->user()->username); ?> - <?php echo e(auth()->user()->role); ?></small>
        </div>
        <a class="<?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('admin.dashboard')); ?>"><i class="fas fa-chart-line me-2"></i>Dashboard</a>
        <a class="<?php echo e(request()->routeIs('admin.complaints.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.complaints.index')); ?>"><i class="fas fa-clipboard-list me-2"></i>Data Pengaduan</a>
        <?php if(auth()->user()->isSuperadmin()): ?>
            <a class="<?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.users.index')); ?>"><i class="fas fa-user-shield me-2"></i>Data Petugas</a>
            <a class="<?php echo e(request()->routeIs('admin.feedback.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.feedback.index')); ?>"><i class="fas fa-comment-dots me-2"></i>Feedback</a>
        <?php endif; ?>
        <a class="<?php echo e(request()->routeIs('admin.profile.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.profile.edit')); ?>"><i class="fas fa-user-cog me-2"></i>Profil</a>
        <form method="post" action="<?php echo e(route('logout')); ?>" class="mt-3"><?php echo csrf_field(); ?><button><i class="fas fa-sign-out-alt me-2"></i>Logout</button></form>
    </aside>
    <main class="main">
...
<?php /**PATH C:\xampp\htdocs\pengmas\KILASAN\resources\views/layouts/admin.blade.php ENDPATH**/ ?>