...
<body>
    <div class="header">
        ...
        <div class="header-right">
            <?php
                // Gunakan path absolut dari sistem file (sesuaikan dengan lokasi proyek Anda)
                $logoPath = 'C:/xampp/htdocs/pengmas/KILASAN/public/assets/newlogo.png';
                
                // Jika file tidak ditemukan, coba path relatif menggunakan public_path()
                if (!file_exists($logoPath)) {
                    $logoPath = public_path('assets/newlogo.png');
                }
            ...
            ?>
            <?php if($logoBase64): ?>
                <img src="<?php echo e($logoBase64); ?>" class="logo" alt="Logo KILASAN">
            <?php else: ?>
                <span style="color:#ccc;">[Logo tidak tersedia]</span>
            <?php endif; ?>
        </div>
    </div>

    <!-- Sisanya sama persis seperti kode asli Anda -->
    <div class="row">
