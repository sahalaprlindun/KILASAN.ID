        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link" href="{{ route('reports.create') }}">Lapor Online</a></li>
...
<main>
    @if (session('success'))
        <div class="container mt-4"><div class="alert alert-success">{{ session('success') }}</div></div>
    @endif
    @if ($errors->any())
...
<footer class="footer">
    <div class="container">
        <div class="row align-items-start">
            ...
            <div class="col-md-4">
                <p class="mb-0"><i class="fab fa-whatsapp me-2"></i>0811-129-129<br><i class="fas fa-globe me-2"></i><a href="{{ route('reports.create') }}">Lapor Online</a></p>
            </div>
        </div>
    </div>
</footer>
